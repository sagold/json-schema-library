...
describe("compileSchema : reduceNode", () => {
    ...
    it("should return schema for boolean schema true", () => {
        ...
        const schema = (_b = (_a = node.reduceNode(123)) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.schema;
    ...
    it("should resolve both if-then-else and allOf schema", () => {
        ...
        const schema = (_b = (_a = node.reduceNode({ withHeader: true, header: "huhu" })) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.schema;
    ...
    describe("object - merge all reduced dynamic schema", () => {
        it("should reduce patternProperties and allOf", () => {
            ...
            const schema = (_b = (_a = node.reduceNode({ "107": undefined })) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.schema;
    ...
    describe("dynamicId", () => {
        ...
        it("should prefix with schemaId", () => {
            ...
            const { node } = (_b = (_a = compileSchema({
                ...
                .node) === null || _a === void 0 ? void 0 : _a.reduceNode(3)) !== null && _b !== void 0 ? _b : {};
