...
describe("validateAsync", () => {
    ...
    it("should resolve successfull with an empty error", () => validateAsync(core, 4, { schema: { type: "number" } })
        .then((errors) => {
        expect(errors).to.have.length(0);
    }));
    it("should resolve with errors for a failed validation", () => validateAsync(core, "4", { schema: { type: "number" } })
        .then((errors) => {
