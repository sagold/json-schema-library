    ...
    describe("oneOf", () => {
        ...
        describe("oneOfProperty", () => {
            it("should return schema where 'oneOfProperty'-value matches schema", () => {
                const result = core.resolveOneOf({ id: "2" }, {
                    oneOfProperty: "id",
                    oneOf: [
        ...
        describe("fuzzyMatch", () => {
            it("should return schema where most properties match", () => {
                const result = core.resolveOneOf({ id: "4", a: 1, b: 2 }, {
                    oneOf: [
                ...
                expect(result).to.deep.equal({ properties: { id: { pattern: "^2$" }, a: { type: "string" }, b: { type: "number" } } });
            });
        });
    });
});
