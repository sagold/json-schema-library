...
const TypeValidation = {
    ...
    array: (core, schema, value, pointer) => {
        ...
        const errors = core.typeKeywords.array.map((key) => core.validateKeyword[key](core, schema, value, pointer));
    ...
    object: (core, schema, value, pointer) => {
        ...
        const errors = core.typeKeywords.object.map((key) => core.validateKeyword[key](core, schema, value, pointer));
    ...
    string: (core, schema, value, pointer) =>
        core.typeKeywords.string.map((key) => core.validateKeyword[key](core, schema, value, pointer)),

    integer: (core, schema, value, pointer) => core.validateType.number(core, schema, value, pointer),

    number: (core, schema, value, pointer) =>
        core.typeKeywords.number.map((key) => core.validateKeyword[key](core, schema, value, pointer)),
